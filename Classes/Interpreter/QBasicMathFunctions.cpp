...
unordered_map<string, QBasicStatementEntity> QBasicMathFunctions::buildStatements() {
	...
	entity = QBasicStatementEntity("abs", abs_params(), { VariableType::Int }, abs_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("abs", fabs_params(), { VariableType::Float }, fabs_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("max", max_params(), { VariableType::Int }, max_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("max", fmax_params(), { VariableType::Float }, fmax_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("min", min_params(), { VariableType::Int }, min_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("min", fmin_params(), { VariableType::Float }, fmin_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("sin", sin_params(), { VariableType::Float }, sin_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("cos", cos_params(), { VariableType::Float }, cos_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("tan", tan_params(), { VariableType::Float }, tan_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("asin", asin_params(), { VariableType::Float }, asin_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("acos", acos_params(), { VariableType::Float }, acos_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("atan", atan_params(), { VariableType::Float }, atan_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("atan2", atan2_params(), { VariableType::Float }, atan2_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("sinh", sinh_params(), { VariableType::Float }, sinh_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("cosh", cosh_params(), { VariableType::Float }, cosh_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("tanh", tanh_params(), { VariableType::Float }, tanh_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("cbrt", cbrt_params(), { VariableType::Float }, cbrt_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("pow", pow_params(), { VariableType::Float }, pow_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("sqrt", sqrt_params(), { VariableType::Float }, sqrt_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("exp", exp_params(), { VariableType::Float }, exp_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("log", log_params(), { VariableType::Float }, log_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("log10", log10_params(), { VariableType::Float }, log10_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("deg2rad", deg2rad_params(), { VariableType::Float }, deg2rad_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("rad2deg", rad2deg_params(), { VariableType::Float }, rad2deg_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("rand", rand_params(), { VariableType::Int }, rand_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("round", round_params(), { VariableType::Float }, round_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("floor", floor_params(), { VariableType::Float }, floor_qb, nullptr);
	statementList[entity.alias] = entity;
	entity = QBasicStatementEntity("ceil", ceil_params(), { VariableType::Float }, ceil_qb, nullptr);
	statementList[entity.alias] = entity;
